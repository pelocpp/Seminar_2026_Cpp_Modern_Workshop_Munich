...
namespace Auto_Examples {
    ...
    static auto sum(short f1, short f2)
    {
        return f1 + f2;
    }

    //static auto doSomething(bool flag, float n, double d) -> double {
    ...
    static auto doSomething(bool flag, T n, U d) -> decltype( n + d) {
    ...
    //template <typename U>
    //static auto doSomething(bool flag, int n, U d) -> int;

    template <typename T, typename U>
    static decltype (  std::declval<T>() + std::declval<U>())
        doSomething2(bool flag, T n, U d) {
    ...
    static void test_doSomething()
    {
        auto result1 = doSomething(false, 123.45f, 123.0f);

        auto result2 = doSomething(false, 123, 123ll);
    }

    //123.456 + 234.234f = double;
    //123 + 123l : long
    ...
    static void test_06() {
        ...
        const auto& name1 = hans.getName();  // no copy of m_name
